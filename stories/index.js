...
const interviewers = [
  ...
  { id: 2, name: "Samwise Gamgee", avatar: "https://i.imgur.com/Nmx0Qxo.png" },
  { id: 3, name: "Gandalf the Grey", avatar: "https://i.imgur.com/T2WwVfS.png" },
  { id: 4, name: "Gollum", avatar: "https://i.imgur.com/FK8V841.jpg" },
  { id: 5, name: "Thorin Oakenshield", avatar: "https://i.imgur.com/twYrpay.jpg" }
];
...
storiesOf("Appointment", module)
  ...
  .add("Show", () => <Show student="Name" interviewer={interviewer.name} onEdit={action("onEdit")} onDelete={action("onDelete")} />)
  .add("Confirm", () => (<Confirm message="Delete this appointment?" onConfirm={action("onConfirm")} onCancel={action("onCancel") } />))
  .add("Status", () => <Status message="Deleting"/>)
  .add("Error", () => <Error message="Sorry, could not delete appointment." onClose={action("onClose")} />)
  .add("Edit", () => (<Form name="Bilbo Baggins" interviewers={interviewers} interviewer={interviewers.id} onSave={action("onSave")} onCancel={action("onCancel")} 
  />))
